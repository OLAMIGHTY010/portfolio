      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {settings.flowmart_problem_painpoints.map((point: string, i: number) => (
              <StaggerItem key={i}>
          ...
          <div className="max-w-4xl mx-auto">
            <StaggerContainer className="relative">
              ...
              <div className="space-y-8">
                {settings.flowmart_user_journey.map((step: { step: string; description: string }, i: number) => {
          ...
          <div className="container-custom">
            ...
            <FadeIn delay={0.2}>
              <div className="flex flex-wrap justify-center gap-3 max-w-2xl mx-auto">
                {settings.flowmart_tech_stack.map((tech: string) => (
                  <Badge
                    key={tech}
                    variant="outline"
