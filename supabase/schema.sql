...
create table if not exists public.site_settings (
  ...
  about_story text,
  flowmart_tagline text,
  flowmart_headline text,
  flowmart_subheadline text,
  flowmart_vision text,
  flowmart_mission text,
  flowmart_problem_title text,
  flowmart_problem_description text,
  flowmart_problem_painpoints jsonb,
  flowmart_tech_stack jsonb,
  flowmart_role_title text,
  flowmart_role_description text,
  flowmart_user_journey jsonb,
  created_at timestamptz default now(),
  updated_at timestamptz default now()
);
